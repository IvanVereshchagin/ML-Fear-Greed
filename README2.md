...
- Инвест-форумы (например, сообщество ПУЛЬС от Т-Инвестиции)  
- Посты и публикации с обзорами  
- Демонстрация результатов использования сервиса в реальной торговле
